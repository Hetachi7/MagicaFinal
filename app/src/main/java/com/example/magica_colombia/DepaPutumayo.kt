...
class DepaPutumayo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_putumayo)
        val CardAmaOpen: CardView = findViewById(R.id.Putumayo1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Putumayo2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Putumayo3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Putumayo4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Putumayo5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Putumayo6card)
