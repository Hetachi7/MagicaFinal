...
class DepaTolima : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_tolima)
        val CardAmaOpen: CardView = findViewById(R.id.Tolima1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Tolima2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Tolima3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Tolima4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Tolima5card)
