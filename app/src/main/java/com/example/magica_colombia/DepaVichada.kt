...
class DepaVichada : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_vichada)
        val CardAmaOpen: CardView = findViewById(R.id.Vichada1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Vichada2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Vichada3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Vichada5card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Vichada6card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Tolima6card)
