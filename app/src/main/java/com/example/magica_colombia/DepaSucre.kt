...
class DepaSucre : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_sucre)
        val CardAmaOpen: CardView = findViewById(R.id.Sucre1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Sucre2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Sucre3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Sucre4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Sucre5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Sucre6card)
