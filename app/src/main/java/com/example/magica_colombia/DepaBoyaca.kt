...
class DepaBoyaca : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_boyaca)
        val CardAmaOpen: CardView = findViewById(R.id.Boyaca1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Boyaca2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Boyaca3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Boyaca4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Boyaca5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Boyaca6card)
