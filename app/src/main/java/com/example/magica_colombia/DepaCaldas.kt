...
class DepaCaldas : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_caldas)
        val CardAmaOpen: CardView = findViewById(R.id.Caldas1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Caldas2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Caldas3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Caldas4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Caldas5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Caldas6card)
