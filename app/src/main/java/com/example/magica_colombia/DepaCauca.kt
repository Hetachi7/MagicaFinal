...
class DepaCauca : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_cauca)

        val CardAmaOpen: CardView = findViewById(R.id.Cauca1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Cauca2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Cauca3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Cauca4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Cauca5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Cauca6card)
