...
class DepaCaqueta : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_caqueta)
        val CardAmaOpen: CardView = findViewById(R.id.Caqueta1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Caqueta2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Caqueta3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Caqueta4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Caqueta5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Caqueta6card)
