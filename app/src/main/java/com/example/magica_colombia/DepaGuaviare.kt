...
class DepaGuaviare : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_guaviare)
        val CardAmaOpen: CardView = findViewById(R.id.Guaviare1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Guaviare2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Guaviare3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Guaviare4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Guaviare5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Guaviare6card)
