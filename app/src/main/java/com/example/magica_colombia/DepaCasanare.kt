...
class DepaCasanare : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_casanare)
        val CardAmaOpen: CardView = findViewById(R.id.Casanare1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Casanare2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Casanare3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Casanare4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Casanare5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Casanare6card)
