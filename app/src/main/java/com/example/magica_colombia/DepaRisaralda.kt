...
class DepaRisaralda : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_risaralda)

        val CardAmaOpen: CardView = findViewById(R.id.Risaralda1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Risaralda2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Risaralda3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Risaralda4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Risaralda5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Risaralda6card)
