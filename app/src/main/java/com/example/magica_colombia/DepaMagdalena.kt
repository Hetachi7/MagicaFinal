...
class DepaMagdalena : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_magdalena)
        val CardAmaOpen: CardView = findViewById(R.id.Magdalena1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Magdalena2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Magdalena3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Magdalena4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Magdalena5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Magdalena6card)
