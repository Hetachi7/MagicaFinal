...
class DepaMeta : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_meta)
        val CardAmaOpen: CardView = findViewById(R.id.Meta1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Meta2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Meta3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Meta4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Meta5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Meta6card)
