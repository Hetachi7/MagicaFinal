...
class DepaCordoba : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_cordoba)


            val CardAmaOpen: CardView = findViewById(R.id.Cordoba1card)
            ...
            val CardOpen2: CardView = findViewById(R.id.Cordoba2card)
            ...
            val CardOpen3: CardView = findViewById(R.id.Cordoba3card)
            ...
            val CardOpen4: CardView = findViewById(R.id.Cordoba4card)
            ...
            val CardOpen5: CardView = findViewById(R.id.Cordoba5card)
            ...
            val CardOpen6: CardView = findViewById(R.id.Cordoba6card)
