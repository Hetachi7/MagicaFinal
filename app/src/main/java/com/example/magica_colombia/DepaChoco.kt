...
class DepaChoco : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_choco)
        val CardAmaOpen: CardView = findViewById(R.id.Choco1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Choco2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Choco3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Choco4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Choco5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Choco6card)
