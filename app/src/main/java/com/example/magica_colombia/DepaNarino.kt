...
class DepaNarino : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_narino)
        val CardAmaOpen: CardView = findViewById(R.id.Narino1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Narino2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Narino3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Narino4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Narino5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Narino6card)
