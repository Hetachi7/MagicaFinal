...
class DepaAntioquia : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val CardAmaOpen: CardView = findViewById(R.id.Antioquia1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Antioquia2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Antioquia3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Antioquia4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Antioquia5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Antioquia6card)
