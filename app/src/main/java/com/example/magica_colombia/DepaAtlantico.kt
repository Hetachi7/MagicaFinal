...
class DepaAtlantico : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val CardAmaOpen: CardView = findViewById(R.id.Atlantico1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Atlantico2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Atlantico3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Atlantico4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Atlantico5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Atlantico6card)
