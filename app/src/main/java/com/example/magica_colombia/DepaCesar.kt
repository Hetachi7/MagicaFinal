...
class DepaCesar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_cesar)
        val CardAmaOpen: CardView = findViewById(R.id.Cesar1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Cesar2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Cesar3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Cesar4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Cesar5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Cesar6card)
