...
class DepaSantander : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_santander)
        val CardAmaOpen: CardView = findViewById(R.id.Santander1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Santander2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Santander3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Santander4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Santander5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Santander6card)
