...
class DepaNSantander : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_nsantander)
        val CardAmaOpen: CardView = findViewById(R.id.NSantander1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.NSantander2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.NSantander3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.NSantander4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.NSantander5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.NSantander6card)
