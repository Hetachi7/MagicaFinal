...
class DepaGuainia : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_guainia)
        val CardAmaOpen: CardView = findViewById(R.id.Guainia1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Guainia2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Guainia3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Guainia4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Guainia5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Guainia6card)
