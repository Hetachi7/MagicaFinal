...
class DepaValleCauca : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_valle_cauca)
        val CardAmaOpen: CardView = findViewById(R.id.ValleCauca1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.ValleCauca2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.ValleCauca3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.ValleCauca4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.ValleCauca5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.ValleCauca6card)
