...
class DepaBolivar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_bolivar)
        val CardAmaOpen: CardView = findViewById(R.id.Bolivar1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Bolivar2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Bolivar3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Bolivar4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Bolivar5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Bolivar6card)
