...
class DepaVaupes : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_vaupes)
        val CardAmaOpen: CardView = findViewById(R.id.Vaupes1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Vaupes2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Vaupes3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Vaupes4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Vaupes5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Vaupes6card)
