...
class DepaGuajira : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_guajira)
        val CardAmaOpen: CardView = findViewById(R.id.Guajira1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Guajira2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Guajira3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Guajira4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Guajira5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Guajira6card)
