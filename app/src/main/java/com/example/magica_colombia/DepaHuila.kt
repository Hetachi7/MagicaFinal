...
class DepaHuila : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_depa_huila)
        val CardAmaOpen: CardView = findViewById(R.id.Huila1card)
        ...
        val CardOpen2: CardView = findViewById(R.id.Huila2card)
        ...
        val CardOpen3: CardView = findViewById(R.id.Huila3card)
        ...
        val CardOpen4: CardView = findViewById(R.id.Huila4card)
        ...
        val CardOpen5: CardView = findViewById(R.id.Huila5card)
        ...
        val CardOpen6: CardView = findViewById(R.id.Huila6card)
